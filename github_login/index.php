...
if(isset($accessToken)){
    ...
    $output = '<a href="'.htmlspecialchars($loginURL).'"><img src="images/github-login.png">Login with GitHub using PHP</a>';
}
?>
...
<div class="container">
    ...
    <div class="wrapper"><a href="logout.php">logout</a></div>
    <hr/>
    <?php
    // session_start();
    $accessToken=$_SESSION['my_access_token_accessToken'];

    echo '<p>access Then :<code> '.$accessToken.'</code></p>';

    if($accessToken != ""){
        echo "<p>Loggin</p>";
    }else{
        echo '<div><a href="https://github.com/login/oauth/authorize?client_id=9a68eb10a46511939710">Login with GitHub using PHP</a></div>';
    }
